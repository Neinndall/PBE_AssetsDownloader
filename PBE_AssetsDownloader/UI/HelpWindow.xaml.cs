...
// Importa tus namespaces de utilidades y servicios
using PBE_AssetsDownloader.Utils; // Para BackgroundHelper, ApplicationInfos (si los adaptas)
using PBE_AssetsDownloader.Info; // Para ApplicationInfos (si lo adaptas)
using PBE_AssetsDownloader.Services; // Para UpdateManager
