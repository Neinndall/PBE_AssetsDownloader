    ...
    public static class DefaultCategories
    {
        public static List<AssetCategory> Get()
        {
            return new List<AssetCategory>
            {
                ...
                new AssetCategory { Id = "10", Name = "Banners", BaseUrl = "https://d392eissrffsyf.cloudfront.net/storeImages/regaliaBanner/regalia_banner_", Start = 13, Extension = "png" },
                new AssetCategory { Id = "11", Name = "Skins Augments", BaseUrl = "https://d392eissrffsyf.cloudfront.net/storeImages/skinaugment/", Start = 4, Extension = "png" },
                new AssetCategory { Id = "12", Name = "Skins Variants", BaseUrl = "https://d392eissrffsyf.cloudfront.net/storeImages/bundles/", Start = 91000006, Extension = "jpg" }
            };
        }
    }
}
