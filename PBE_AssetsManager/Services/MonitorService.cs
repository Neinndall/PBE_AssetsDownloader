...
namespace PBE_AssetsManager.Services
{
    public class MonitorService
    {
        ...
        {
            _logService.Log($"MonitorService: FileUpdated event received for URL: {fileUpdateInfo.FullUrl}");
            ...
            if (item != null)
            {
                Application.Current.Dispatcher.Invoke(() =>
                {
                    ...
                    item.LastChecked = $"Checked {fileUpdateInfo.Timestamp:yyyy-MMM-dd HH:mm}";
            ...
            else
            {
                ...
                _logService.Log("MonitorService: Currently monitored URLs:");
                foreach (var monitoredItem in MonitoredItems)
                {
                    _logService.Log($"- {monitoredItem.Url}");
                }
            }
        }
