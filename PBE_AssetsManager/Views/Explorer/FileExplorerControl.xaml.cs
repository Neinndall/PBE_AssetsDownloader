...
namespace PBE_AssetsManager.Views.Explorer
{
    ...
    {
        // Event to notify parent of file selection
        ...
        public FileExplorerControl()
        {
            ...
            _hashResolverService = App.ServiceProvider.GetRequiredService<HashResolverService>();
            _wadNodeLoaderService = App.ServiceProvider.GetRequiredService<WadNodeLoaderService>();
