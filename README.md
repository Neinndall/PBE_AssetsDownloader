...
# Collaborate
If you want to collaborate with the project, you can make pull requests with the detailed idea or present any room for improvement. I would be super happy to receive people who can collaborate with this project.

# License
PBE_AssetsDownloader is under [GPL-3](https://github.com/Neinndall/PBE_AssetsDownloader/blob/main/LICENSE).
