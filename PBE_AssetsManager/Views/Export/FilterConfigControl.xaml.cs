...
namespace PBE_AssetsManager.Views.Export
{
    public partial class FilterConfigControl : UserControl
    {
        ...
        public FilterConfigControl()
        {
            ...
            _assetDownloader = App.ServiceProvider.GetRequiredService<AssetDownloader>();
            _serviceProvider = App.ServiceProvider.GetRequiredService<IServiceProvider>();
        ...
        public void DoPreview(string differencesPath)
        {
            ...
            previewWindow.InitializeData(differencesPath, selectedAssetTypes, FilterAssetsByType);
