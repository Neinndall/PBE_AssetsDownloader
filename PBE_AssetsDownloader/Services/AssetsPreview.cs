...
namespace PBE_AssetsDownloader.Services
{
  ...
  public class AssetsPreview
  {
    ...
    private readonly DirectoriesCreator _directoriesCreator; // Inyectar DirectoriesCreator
    ...
    public AssetsPreview(
        ...
        DirectoriesCreator directoriesCreator) // Añadir DirectoriesCreator al constructor
    {
      _logService = logService;
      _assetDownloader = assetDownloader;
      _filterAssetsByType = filterAssetsByType;
      _directoriesCreator = directoriesCreator; // Asignar la instancia
    }
